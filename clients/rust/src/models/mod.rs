...
pub use self::component_metadata::ComponentMetadata;
...
pub mod locked_component;
pub use self::locked_component::LockedComponent;
pub mod locked_manifest;
pub use self::locked_manifest::LockedManifest;
pub mod locked_manifest_metadata;
pub use self::locked_manifest_metadata::LockedManifestMetadata;
pub mod locked_trigger;
pub use self::locked_trigger::LockedTrigger;
